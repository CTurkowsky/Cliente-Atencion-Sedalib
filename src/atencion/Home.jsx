...
export const Home = () => {
  return (
    <div className="flex flex-col items-center justify-center h-screen transition-all duration-500 ease-in-out opacity-0 animate-fadeIn">
      <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-4xl font-medium mb-4 animate-pulse">Bienvenido a Gestion de Atenciones 📞</h1>
      <p className="text-sm sm:text-base md:text-lg lg:text-xl mb-8">Buen inicio de turno</p>
